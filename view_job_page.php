				...
				<div class="col-lg-12 col-md-12 profile_content">
					<div class="row">
						<div class="col-lg-2 col-md-2">
							<img style="width: 120px;" src="images/google.png">
							<img style="width: 120px;" src="images/rating.png">
						</div>
						...
						<div class="col-lg-2 col-md-2" style="text-align: center; margin-top: 40px;">
							<p style="font-size: 30px;">98% <br><span style="font-size: 15px;">Match</span></p>
						</div>
					</div>
				</div>
			</div>
